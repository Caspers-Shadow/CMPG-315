...
class ChatClientGUI:
    def __init__(self, master):
        ...
        self.username_label = tk.Label(self.username_frame, text="Enter your username:", 
                                    font=("Segoe UI", 14), bg=self.bg_color, fg=self.text_color)
        ...
        self.username_button = tk.Button(self.username_frame, text="Connect", 
                                      font=("Segoe UI", 12, "bold"), bg=self.accent_color, fg="white", 
                                      activebackground="#6EC51B", activeforeground="white", relief="flat", command=self.submit_username, cursor="hand2")
