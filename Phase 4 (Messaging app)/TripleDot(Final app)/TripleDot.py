...
class ChatClientGUI:
    def __init__(self, master):
        ...
        # Load and place logo
        logo_img = Image.open(resource_path("Chat app logo-Photoroom.png")).resize((120, 120))
        self.logo = ImageTk.PhotoImage(logo_img)
        logo_label = tk.Label(master, image=self.logo, bg="#1e1e1e")
        logo_label.pack(pady=(15, 0))
        
        self.title_label = tk.Label(master, text="Welcome to '...'", font=("Helvetica", 18, "bold"), fg="#7ED957", bg="#1e1e1e")
        self.title_label.pack(pady=(10, 10))
        
        # Username input frame (initial view)
        self.username_frame = tk.Frame(master, bg="#2b2b2b", relief="flat")
        self.username_frame.pack(pady=(10, 5), padx=30, fill="x")

        self.username_label = tk.Label(self.username_frame, text="Enter your username:", font=("Helvetica", 15, "bold"), fg="white", bg="#2b2b2b")
        self.username_label.pack(pady=(150, 10))


        self.username_entry = tk.Entry(self.username_frame, font=("Helvetica", 12), bg="#2b2b2b", fg="white", insertbackground="white", relief="flat")
        self.username_entry.pack(pady=(15, 5), padx=30, fill="x")
        self.username_entry.focus()  # Set focus to the entry
 
        self.username_button = tk.Button(self.username_frame, text="Join Chat!", 
                                      font=("Helvetica", 12, "bold"), bg="#7ED957", fg="black", relief="flat", cursor="hand2",
                                      command=self.submit_username)
        self.username_button.pack(pady=10)
        
        # Chat UI elements (hidden until username is submitted)
        self.chat_frame = tk.Frame(master, bg="#2b2b2b", relief="flat")
        ...
        self.sidebar_frame = tk.Frame(self.chat_frame, bg="#2b2b2b", width=150)
        self.sidebar_frame.pack(side=tk.LEFT, fill=tk.Y, padx=5, pady=5)
        
        self.online_label = tk.Label(self.sidebar_frame, text="Online Users", font=("Helvetica", 12, "bold"), fg="white", bg="#2b2b2b")
        self.online_label.pack(pady=5)
        
        self.users_listbox = tk.Listbox(self.sidebar_frame, font=("Helvetica", 11), bg="#d3d3d3", height=15, width=15)
    ...
    def setup_group_tab(self):
        ...
        self.group_text_area = scrolledtext.ScrolledText(self.group_tab, wrap=tk.WORD, state='disabled', height=20, font=("Helvetica", 11), bg="white")
        ...
        self.group_send_button = tk.Button(input_frame, text="Send", font=("Helvetica", 11, "bold"), 
                                        bg="#7ED957", fg="black", 
    ...
    def setup_private_tab(self, to_user):
        ...
        # Message display area
        text_area = scrolledtext.ScrolledText(private_tab, wrap=tk.WORD, state='disabled', height=20, font=("Helvetica", 11), bg="#d3d3d3", fg="#2b2b2b")
        ...
        entry = tk.Entry(input_frame, font=("Helvetica", 11), width=50, bg="white")
        ...
        send_button = tk.Button(input_frame, text="Send", font=("Helvetica", 11, "bold"), 
                             bg="#7ED957", fg="black", 
